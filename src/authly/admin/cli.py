        ...
        async with get_api_client() as client:
            try:
                ...
                if verbose:
                    ...
                    env_vars = [
                        ("AUTHLY_API_URL", "✅ Set" if os.getenv("AUTHLY_API_URL") else "⚠️  Using default (http://localhost:8000)"),
                        ...
                        ("ACCESS_TOKEN_EXPIRE_MINUTES", "✅ Set" if os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES") else "⚠️  Using default (60)"),
                        ("REFRESH_TOKEN_EXPIRE_DAYS", "✅ Set" if os.getenv("REFRESH_TOKEN_EXPIRE_DAYS") else "⚠️  Using default (7)"),
                    ]
