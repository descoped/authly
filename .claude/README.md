...
- **[codebase-structure-current.md](codebase-structure-current.md)** - Codebase structure documentation ⭐ **NEW**
...
- **[psycopg3-transaction-patterns.md](psycopg3-transaction-patterns.md)** - Database transaction patterns
