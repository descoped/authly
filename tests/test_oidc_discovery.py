...
class TestOIDCDiscoveryService:
    ...
    async def test_get_oidc_server_metadata(
        self, oidc_discovery_service, mock_oauth_discovery_service, sample_oauth_metadata
    ):
    ...
    async def test_oidc_metadata_with_custom_issuer(
        self, oidc_discovery_service, mock_oauth_discovery_service, sample_oauth_metadata
    ):
