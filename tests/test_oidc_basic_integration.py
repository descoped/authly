...
class TestOIDCBasicIntegration:
    ...
    @pytest.mark.asyncio
    async def test_oidc_discovery_endpoint_compliance(
        self, 
    ...
    @pytest.mark.asyncio
    async def test_jwks_endpoint_provides_keys(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_userinfo_endpoint_authentication_required(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_oauth_discovery_endpoint_consistency(
        self, 
        oidc_server: AsyncTestServer
    ):
        ...
        # Get OIDC discovery metadata
        oidc_discovery_response = await oidc_server.client.get("/.well-known/openid_configuration")
    ...
    @pytest.mark.asyncio
    async def test_authorization_endpoint_accepts_oidc_params(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_token_endpoint_password_grant_behavior(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_unsupported_response_types_rejected(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_authorization_code_grant_recognized(
        self, 
        oidc_server: AsyncTestServer
    ):
    ...
    @pytest.mark.asyncio
    async def test_endpoint_integration_consistency(
        self, 
        oidc_server: AsyncTestServer
    ):
