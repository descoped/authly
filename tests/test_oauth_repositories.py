...
class TestClientRepository:
    ...
    @pytest.mark.asyncio
    async def test_create_client(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_get_client_by_id(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_get_client_by_client_id(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_update_client(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_delete_client(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_client_scope_association(self, initialize_authly: Authly, test_client_data: dict, test_scope_data: dict, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_client_id(self, initialize_authly: Authly, test_client_data: dict, transaction_manager: TransactionManager):
...
class TestScopeRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_scope_by_name(self, initialize_authly: Authly, test_scope_data: dict, transaction_manager: TransactionManager):
    ...
    async def test_get_active_scopes(self, initialize_authly: Authly, transaction_manager: TransactionManager):
        ...
        async with transaction_manager.transaction() as conn:
            ...
            assert len(active_scopes) == expected_active_count, f"Expected {expected_active_count} active scopes, got {len(active_scopes)}"
            ...
            for expected_scope in expected_active_scopes:
                assert expected_scope.scope_name in active_scope_names, f"Expected scope '{expected_scope.scope_name}' not found in active scopes"
    ...
    @pytest.mark.asyncio
    async def test_token_scope_association(self, initialize_authly: Authly, test_scope_data: dict, transaction_manager: TransactionManager):
...
class TestAuthorizationCodeRepository:
    ...
    @pytest.mark.asyncio
    async def test_create_authorization_code(self, initialize_authly: Authly, test_client_data: dict, test_authorization_code_data: dict, test_user: UserModel, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_get_authorization_code(self, initialize_authly: Authly, test_client_data: dict, test_authorization_code_data: dict, test_user: UserModel, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_consume_authorization_code(self, initialize_authly: Authly, test_client_data: dict, test_authorization_code_data: dict, test_user: UserModel, transaction_manager: TransactionManager):
    ...
    @pytest.mark.asyncio
    async def test_verify_pkce_challenge(self, initialize_authly: Authly, test_client_data: dict, test_authorization_code_data: dict, test_user: UserModel, transaction_manager: TransactionManager):
        ...
        async with transaction_manager.transaction() as conn:
            ...
            is_valid = await authz_repo.verify_pkce_challenge(
                created_code.code, correct_verifier
            )
            ...
            is_valid = await authz_repo.verify_pkce_challenge(
                created_code.code, incorrect_verifier
            )
            assert is_valid is False

    @pytest.mark.asyncio
    async def test_cleanup_expired_codes(self, initialize_authly: Authly, test_client_data: dict, test_user: UserModel, transaction_manager: TransactionManager):
